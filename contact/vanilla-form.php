...
function sendMessage() {
     ...
     */
    $title = 'Contacto desde la web www.deccsa.cl '.$contact_name;
    $message = 'Hola,'."\n\n"
        .'Has recibido un mensaje del sitio web:'."\n\n"
        .'De\'s IP address: '.getIp()."\n"
        .'Nombre: '.$contact_name."\n"
